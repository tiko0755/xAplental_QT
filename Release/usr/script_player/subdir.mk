...
C_SRCS += \
../usr/script_player/script_player.c 

OBJS += \
./usr/script_player/script_player.o 

C_DEPS += \
./usr/script_player/script_player.d 


# Each subdirectory must supply rules for building sources it contributes
usr/script_player/%.o usr/script_player/%.su: ../usr/script_player/%.c usr/script_player/subdir.mk
...
clean: clean-usr-2f-script_player

clean-usr-2f-script_player:
	-$(RM) ./usr/script_player/script_player.d ./usr/script_player/script_player.o ./usr/script_player/script_player.su

.PHONY: clean-usr-2f-script_player
